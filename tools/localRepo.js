 ...
 */
export const scanRepoTree = tool(
  async () => {
    try {
  ...
  },
  {
    name: "scan_repo_tree",
    description:
      "Recursively scan the entire local repository and return a list of all files.",
    schema: z.object({}),
  }
);
...
export const readLocalFile = tool(
  ...
  },
  {
    ...
    description:
      "Read the full text content of a local project file. Only works inside the project root.",
    schema: z.object({
      filePath: z.string(),
    }),
  }
